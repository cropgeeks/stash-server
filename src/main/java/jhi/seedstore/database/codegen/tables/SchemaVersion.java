...
import jhi.seedstore.database.codegen.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    /**
     * The reference instance of <code>stash_db.schema_version</code>
     */
    ...
    /**
     * The column <code>stash_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>stash_db.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>stash_db.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>stash_db.schema_version.installed_on</code>.
     */
    public final TableField<SchemaVersionRecord, Timestamp> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>stash_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * The column <code>stash_db.schema_version.success</code>.
     */
    ...
    /**
     * Create an aliased <code>stash_db.schema_version</code> table reference
     */
    ...
    /**
     * Create a <code>stash_db.schema_version</code> table reference
     */
