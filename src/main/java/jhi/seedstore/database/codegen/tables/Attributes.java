...
public class Attributes extends TableImpl<AttributesRecord> {
    ...
    /**
     * The reference instance of <code>stash_db.attributes</code>
     */
    ...
    /**
     * The column <code>stash_db.attributes.id</code>.
     */
    ...
    /**
     * The column <code>stash_db.attributes.name</code>.
     */
    ...
    /**
     * The column <code>stash_db.attributes.datatype</code>.
     */
    public final TableField<AttributesRecord, AttributesDatatype> DATATYPE = createField(DSL.name("datatype"), SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("text", SQLDataType.VARCHAR)).asEnumDataType(AttributesDatatype.class), this, "");

    /**
     * The column <code>stash_db.attributes.created_on</code>.
     */
    public final TableField<AttributesRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>stash_db.attributes.updated_on</code>.
     */
    public final TableField<AttributesRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");
    ...
    /**
     * Create an aliased <code>stash_db.attributes</code> table reference
     */
    ...
    /**
     * Create a <code>stash_db.attributes</code> table reference
     */
    public Attributes() {
