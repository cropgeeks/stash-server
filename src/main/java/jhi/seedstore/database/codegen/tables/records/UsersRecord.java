...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record7<Integer, String, String, String, UsersUserType, Timestamp, Timestamp> {
    ...
    @Override
    public Row7<Integer, String, String, String, UsersUserType, Timestamp, Timestamp> valuesRow() {
    ...
    @Override
    public Field<UsersUserType> field5() {
    ...
    @Override
    public UsersUserType component5() {
        return getUserType();
    }
    ...
    @Override
    public UsersRecord value5(UsersUserType value) {
        setUserType(value);
        return this;
    }
    ...
    @Override
    public UsersRecord values(Integer value1, String value2, String value3, String value4, UsersUserType value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(Integer id, String name, String emailAddress, String passwordHash, UsersUserType userType, Timestamp createdOn, Timestamp updatedOn) {
        super(Users.USERS);
