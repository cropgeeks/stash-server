...
public class Projects extends TableImpl<ProjectsRecord> {
    ...
    /**
     * The reference instance of <code>stash_db.projects</code>
     */
    ...
    /**
     * The column <code>stash_db.projects.id</code>.
     */
    ...
    /**
     * The column <code>stash_db.projects.name</code>.
     */
    public final TableField<ProjectsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>stash_db.projects.description</code>.
     */
    public final TableField<ProjectsRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>stash_db.projects.user_id</code>.
     */
    public final TableField<ProjectsRecord, Integer> USER_ID = createField(DSL.name("user_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>stash_db.projects.start_date</code>.
     */
    public final TableField<ProjectsRecord, Date> START_DATE = createField(DSL.name("start_date"), SQLDataType.DATE, this, "");

    /**
     * The column <code>stash_db.projects.end_date</code>.
     */
    public final TableField<ProjectsRecord, Date> END_DATE = createField(DSL.name("end_date"), SQLDataType.DATE, this, "");

    /**
     * The column <code>stash_db.projects.created_on</code>.
     */
    public final TableField<ProjectsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>stash_db.projects.updated_on</code>.
     */
    public final TableField<ProjectsRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");
    ...
    /**
     * Create an aliased <code>stash_db.projects</code> table reference
     */
    ...
    /**
     * Create a <code>stash_db.projects</code> table reference
     */
    public Projects() {
