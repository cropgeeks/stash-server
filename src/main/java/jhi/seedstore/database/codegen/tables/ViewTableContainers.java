...
public class ViewTableContainers extends TableImpl<ViewTableContainersRecord> {
    ...
    /**
     * The reference instance of <code>stash_db.view_table_containers</code>
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.container_id</code>.
     */
    public final TableField<ViewTableContainersRecord, Integer> CONTAINER_ID = createField(DSL.name("container_id"), SQLDataType.INTEGER.defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stash_db.view_table_containers.container_barcode</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.parent_id</code>.
     */
     ...
     */
    public final TableField<ViewTableContainersRecord, Boolean> CONTAINER_IS_ACTIVE = createField(DSL.name("container_is_active"), SQLDataType.BOOLEAN.defaultValue(DSL.inline("1", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>stash_db.view_table_containers.trial_id</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.trial_name</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.trial_description</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.project_id</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.project_name</code>.
     */
    ...
    /**
     * The column <code>stash_db.view_table_containers.created_on</code>.
     */
    public final TableField<ViewTableContainersRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");
    ...
    /**
     * Create an aliased <code>stash_db.view_table_containers</code> table
     * reference
     */
    ...
    /**
     * Create a <code>stash_db.view_table_containers</code> table reference
     */
    ...
    @Override
    public ViewTableContainers as(Table<?> alias) {
        return new ViewTableContainers(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableContainers rename(Table<?> name) {
        return new ViewTableContainers(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableContainers where(Condition condition) {
        return new ViewTableContainers(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableContainers where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableContainers where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableContainers where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableContainers where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableContainers where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableContainers where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableContainers where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableContainers whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableContainers whereNotExists(Select<?> select) {
