...
{
	/**
	 * Checks if any of the given {@link String}s is either <code>null</code> or blank.
	 * @param input The inputs to check
	 * @return <code>true</code> if any of the given Strings is null or blank, <code>false</code> otherwise.
	 */
	public static boolean isAnyEmpty(String... input)
	{
		if (input != null)
		{
			return Arrays.stream(input).anyMatch(StringUtils::isEmpty);
		}
		else
		{
			return false;
